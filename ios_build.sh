...
#1. PROJECT LEVEL - Build Settings - Build Active Architecture Only - NO
#2. Build liblbfgs
#3. Open build-os folder containing dylib in Finder
#4. Drag and drop the dylib in XCode (Do not copy) to you target app project
